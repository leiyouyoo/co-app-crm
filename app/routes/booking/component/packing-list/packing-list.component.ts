...
import { CSPProductService } from 'apps/crm/app/services/csp';
import { PUBDataDictionaryService, StorageCSPExcelService, PUBCurrencyService } from '@co/cds';
import { CoConfigManager } from '@co/core';

@Component({
  selector: 'crm-packing-list',
...
export class PackingListComponent implements OnInit {
  ...
  constructor(
    ...
    private pubDataDictionary: PUBDataDictionaryService,
  ...
  getSkuList(skuInput: { searchText?: string; maxResultCount?: number; skipCount?: number }) {
    this.cspProductService.getSkuList(skuInput).subscribe((c) => {
