...
import { CRMQuoteEnquiryService, CRMQuoteEnquiryDto } from 'apps/crm/app/services/crm';
...
export class QuoteSimpleInfoComponent implements OnInit {
  @Input() quoteObj: CRMQuoteEnquiryDto = {};
  @Input() record: any = {};
  @Input() Id: string;
  // @Input() quoteData: any = {};
  ...
  constructor(public router: Router, private crmQuoteEnquiryService: CRMQuoteEnquiryService) {}
