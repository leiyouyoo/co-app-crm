...
export class CurvedRouteComponent implements OnInit {
  ...
  drawRoute() {
    ...
    setTimeout(() => {
      const locationList = Array.from((this.routeRef.nativeElement as HTMLDivElement).querySelectorAll('i')).filter(o => !(o.offsetHeight === 0 && o.offsetWidth === 0));
