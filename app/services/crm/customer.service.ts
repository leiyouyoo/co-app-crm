...
export class CRMCustomerService extends BaseApi {
  constructor(injector: Injector) {
    ...
    /**
     * @param url /CRM/Customer/SaveScheduleAsync
     * 保存日程
     */

    @POST('SaveScheduleAsync')
    saveScheduleAsync(
        @Payload
        _req:CRMScheduleDto

    ): Observable<CRMScheduleDto> {
        return null as any
    }


    /**
     * @param url /CRM/Customer/CustomerAutomaticRecovery
     * 客户自动回收进公海池
     */

    @POST('CustomerAutomaticRecovery')
    ...
    /**
     * @param url /CRM/Customer/UpateLeadTrackingPhase
     * 修改潜在客户追踪阶段
     */

    @POST('UpateLeadTrackingPhase')
    ...
    /**
     * @param url /CRM/Customer/ApplyChangePhone
     * 客户变更电话申请
     */

    @POST('ApplyChangePhone')
    applyChangePhone(
        @Payload
        _req:CRMCustomerChangePhoneInput
    ...
    /**
     * @param url /CRM/Customer/CustomerChangePhoneDetail
     * 变更电话详情
     */

    @GET('CustomerChangePhoneDetail')
    customerChangePhoneDetail(
        @Payload
        _req: {id?:string} 

    ): Observable<CRMChangePhoneDetailDto> {
        return null as any
    }


    /**
     * @param url /CRM/Customer/ApprovalChangePhone
     * 审批修改电话
     */

    @POST('ApprovalChangePhone')
    approvalChangePhone(
        @Payload
        _req:CRMCustomerChangePhoneApprovalInput
