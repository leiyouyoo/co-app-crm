...
export class RatesOceanService extends BaseApi {
  constructor(injector: Injector) {
    ...
    getAll(
        @Payload
        _req: {contractNo?:string,contractName?:string,carrier?:string,pOL?:string,vIA?:string,pOD?:string,delivery?:string,type?:number,state?:number,publisher?:number,shippingLine?:string,from?:string,to?:string,sorting?:string,maxResultCount?:number,skipCount?:number} 
