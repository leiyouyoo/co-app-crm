 ...
 *  No Remark 
 */
export class RatesLocalPortRateDto {
 ...
 *  No Remark 
 */
export class RatesPagedResultDto<RatesQueryFreightRateDto> {
...
export class RatesQueryFreightRateOutput {
        ...
        queryFreightRateDtos?: RatesPagedResultDto<any>;
