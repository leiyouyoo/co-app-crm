...
import { RatesGetFreightRatesInput,RatesQueryFreightRateOutput,RatesPagedResultDto,RatesCrmBusinessRateListOutput,RatesCrmOceanRateDetails, } from './rates.types';
...
export class RatesOceanBaseItemServiceService extends BaseApi {
  constructor(injector: Injector) {
    ...
    @GET('getBusinessRateList')
    getBusinessRateList(
        @Payload
        _req: {isFollow?:boolean,pOL?:string,pOD?:string,delivery?:string,carrier?:string,shipline?:string,commodity?:string,fromDate?:string,toDate?:string,no?:string,id?:string,sorting?:string,maxResultCount?:number,skipCount?:number} 
